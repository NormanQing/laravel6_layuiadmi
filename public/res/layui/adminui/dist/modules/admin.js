...
;layui.define("view", function(e) {
    ...
    layui.setter)
      ...
      , T = {
        ...
        sendAuthCode: function(i) {
            function l(e) {
                --n < 0 ? (t.removeClass(b).html("\u83b7\u53d6\u9a8c\u8bc1\u7801"),
                n = i.seconds,
                clearInterval(a)) : t.addClass(b).html(n + "\u79d2\u540e\u91cd\u83b7"),
            ...
            }, i)).seconds, t = d(i.elem);
            i.elemPhone = d(i.elemPhone),
            i.elemVercode = d(i.elemVercode),
            t.on("click", function() {
                ...
                if (n === i.seconds && !d(this).hasClass(b)) {
                    if (!/^1\d{10}$/.test(t))
                        return e.focus(),
                        layer.msg("\u8bf7\u8f93\u5165\u6b63\u786e\u7684\u624b\u673a\u53f7");
                    "object" == typeof i.ajax && (a = i.ajax.success,
                    delete i.ajax.success),
                    T.req(d.extend(!0, {
                        url: "",
                        type: "get",
                        data: {
        ...
        sideFlexible: function(e) {
            var a = f
              , t = d("#" + g)
              , i = T.screen();
            "spread" === e ? (t.removeClass(F).addClass(P),
            i < 2 ? a.addClass(C) : a.removeClass(C),
            a.removeClass(A)) : (t.removeClass(P).addClass(F),
            i < 2 ? a.removeClass(A) : a.addClass(A),
            a.removeClass(C)),
            layui.event.call(this, r.MOD_NAME, "side({*})", {
                status: e
            })
        },
        popup: o.popup,
        ...
        initTheme: function(e) {
            var a = r.theme;
            a.color[e = e || 0] && (a.color[e].index = e,
            T.theme({
                color: a.color[e]
            }))
        },
        ...
        tabsBodyChange: function(e, a) {
            a = a || {},
            T.tabsBody(e).addClass(h).siblings().removeClass(h),
            _.rollPage("auto", e),
            T.recordURL(a),
            layui.event.call(this, r.MOD_NAME, "tabsPage({*})", a)
        },
        recordURL: function(e) {
            var a;
            (r.record || {}).url && e.url && (/^(\w*:)*\/\/.+/.test(e.url) && (e.url = ""),
            location.hash = T.correctRouter(e.url),
            e.url && e.title && ((a = {})[e.url] = e.title,
            layui.data(r.tableName, {
                key: "record",
                value: a
            })))
        ...
        resize: function(e) {
            ...
            T.resizeFn[a] && (c.off("resize", T.resizeFn[a]),
            delete T.resizeFn[a]),
            "off" !== e && (e(),
            T.resizeFn[a] = e,
            c.on("resize", T.resizeFn[a]))
        },
        resizeFn: {},
        runResize: function() {
      ...
      , _ = T.events = {
        ...
        refresh: function() {
            var e = d("." + k).length;
            T.tabsPage.index >= e && (T.tabsPage.index = e - 1),
            T.tabsBody(T.tabsPage.index).find(".layadmin-iframe")[0].contentWindow.location.reload(!0)
        },
        serach: function(t) {
            t.off("keypress").on("keypress", function(e) {
                var a;
                this.value.replace(/\s/g, "") && 13 === e.keyCode && (e = t.attr("lay-action"),
                a = t.attr("lay-title") || t.attr("lay-text") || "\u641c\u7d22",
                e += this.value,
                a = a + ": " + T.escape(this.value),
                T.openTabsPage({
                    url: e,
                    title: a,
                    highlight: "color: #FF5722;"
                }),
                _.serach.keys || (_.serach.keys = {}),
                _.serach.keys[T.tabsPage.index] = this.value,
                this.value === _.serach.keys[T.tabsPage.index] && _.refresh(t),
                this.value = "")
            })
        },
        message: function(e) {
        ...
        setTheme: function(e) {
            ...
            e.hasClass(p) || (e.addClass(p).siblings(".layui-this").removeClass(p),
            T.initTheme(a),
            o("LAY_adminPopupTheme").render("system/theme"))
        },
        rollPage: function(e, a) {
            var t, i = d("#LAY_app_tabsheader"), l = i.children("li"), n = (i.prop("scrollWidth"),
            i.outerWidth()), s = parseFloat(i.css("left"));
            if ("left" === e)
                !s && s <= 0 || (t = -s - n,
                l.each(function(e, a) {
                    a = d(a).position().left;
                ...
                var r, e = l.eq(a);
                if (e[0]) {
                    if ((a = e.position().left) < -s)
                        return void i.css("left", -a);
                    a + e.outerWidth() >= n - s && (r = a + e.outerWidth() - (n - s),
                    l.each(function(e, a) {
                        a = d(a).position().left;
                        if (0 < a + s && r < a - s)
                            return i.css("left", -a),
        ...
        closeOtherTabs: function(e) {
            var t = "LAY-system-pagetabs-remove"
              , i = T.tabsPage.index;
            "all" === e ? (d(L + ":gt(0)").remove(),
            d(v).find("." + k + ":gt(0)").remove(),
            d(L).eq(0).trigger("click")) : "right" === e ? (d(L + ":gt(" + i + ")").remove(),
            d(v).find("." + k + ":gt(" + i + ")").remove()) : (d(L).each(function(e, a) {
                e && e != i && (d(a).addClass(t),
                T.tabsBody(e).addClass(t))
            }),
            d("." + t).remove())
        },
        closeRightTabs: function() {
            _.closeOtherTabs("right")
        },
      ...
      , L = ("pageTabs"in layui.setter || (layui.setter.pageTabs = !0),
    r.pageTabs || (d("#LAY_app_tabs").addClass("layui-hide"),
    f.addClass("layadmin-tabspage-none")),
    u.ie && u.ie < 10 && o.error("IE" + u.ie + "\u4e0b\u8bbf\u95ee\u53ef\u80fd\u4e0d\u4f73\uff0c\u63a8\u8350\u4f7f\u7528\uff1aChrome / Firefox / Edge \u7b49\u9ad8\u7ea7\u6d4f\u89c8\u5668", {
        offset: "auto",
        id: "LAY_errorIE"
    }),
    (l = layui.data(r.tableName)).theme ? T.theme(l.theme) : r.theme && T.initTheme(r.theme.initColorIndex),
    i.on("tab(" + x + ")", function(e) {
    ...
    T.on("tabsPage(setMenustatus)", function(e) {
        ...
        var r = e.url
          ...
          , u = "layui-nav-itemed";
        e.find("." + p).removeClass(p),
        T.screen() < 2 && T.sideFlexible(),
        e.children("li").each(function(e, a) {
            ...
            if (t.each(function(e, a) {
                var a = d(a)
                  ...
                  , l = o[0] == n.name && o[1] == t.name || r === t.a.attr("lay-href");
                if (i.each(function(e, a) {
                    var a = d(a)
                      , t = s(a);
                    if (r === t.a.attr("lay-href"))
                        return t = t.list[0] ? u : p,
                        a.addClass(t).siblings().removeClass(t),
                        !1
                }),
                l)
                    return i = t.list[0] ? u : p,
                    a.addClass(i).siblings().removeClass(i),
                    !1
            }),
            i)
                return t = n.list[0] ? u : p,
                a.addClass(t).siblings().removeClass(t),
                !1
        })
    }),
    i.on("nav(layadmin-system-side-menu)", function(e) {
        e.siblings(".layui-nav-child")[0] && f.hasClass(A) && (T.sideFlexible("spread"),
    ...
    i.on("tabDelete(" + x + ")", function(e) {
        ...
        e.index && T.tabsBody(e.index).remove(),
        t(a),
        T.delResize()
    }),
    m.on("click", "*[lay-href]", function() {
        ...
        T.tabsPage.elem = e,
        (parent === self ? layui : r.parentLayui || top.layui).admin.openTabsPage({
            url: a,
            title: t
        }),
    ...
    m.on("mouseenter", "*[lay-tips]", function() {
        var t, e, a, i = d(this);
        i.parent().hasClass("layui-nav-item") && !f.hasClass(A) || (a = i.attr("lay-tips"),
        t = i.attr("lay-offset"),
        e = i.attr("lay-direction"),
        a = layer.tips(a, this, {
            tips: e || 1,
            time: -1,
            success: function(e, a) {
    ...
    layui.data.resizeSystem = function() {
        ...
        z.lock || setTimeout(function() {
            T.sideFlexible(T.screen() < 2 ? "" : "spread"),
            delete z.lock
        }, 100),
        z.lock = !0
    }
    );
    c.on("resize", layui.data.resizeSystem),
    y.on("fullscreenchange", function() {
        _.fullscreen(d('[layadmin-event="fullscreen"]'), {
            status: document.fullscreenElement
        })
    }),
    (u = r.request).tokenName && ((l = {})[u.tokenName] = layui.data(r.tableName)[u.tokenName] || "",
    a.set({
        headers: l,
        where: l
    }),
