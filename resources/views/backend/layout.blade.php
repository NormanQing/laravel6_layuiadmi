            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    ...
                    <dl class="layui-nav-child">
                        <dd><a lay-href="{{route('backend.admin.profile')}}">基本资料</a></dd>
                        <hr>
                            ...
                            @if($menu->children->isEmpty())
                                <li class="layui-nav-item">
                                    <a href="{{route($menu->route)}}" lay-tips="{{$menu->display_name}}" lay-direction="2">
                                        @if($menu->icon_type == 2)
                                            <i class="ufa {{$menu->icon_class}} fa-fw"></i>
                                        @else
                                            <i class="layui-icon {{$menu->icon_class}}"></i>
                                        @endif
                                ...
                                <li data-name="component" class="layui-nav-item">
                                    ...
                                    <dl class="layui-nav-child">
                                        ...
                                        @foreach($menu->children as $child)
                                            @can($child->name)
                                                <dd data-name="button">
                                                    @if($child->icon_type == 2)
                                                        <i class="ufa {{$child->icon_class}}  fa-fw"></i>
                                                    @else
                                                        <i class="layui-icon {{$child->icon_class}}"></i>
                                                    @endif
