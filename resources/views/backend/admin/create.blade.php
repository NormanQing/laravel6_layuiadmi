...
@section('content')
    <div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="phone" lay-verify="required" placeholder="请输入号码" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="password" name="password_confirmation" lay-verify="required" placeholder="确认密码"
        ...
        <script>
            layui.use(['form', 'layer'], function () {
                ...
                form.on('submit(layuiadmin-app-form-submit)', function (data) {
                    ...
                    $.ajax({
                        url: '{{route("backend.admin.store")}}', // 获取颜色数据的接口
                        type: 'POST',
                        data: field,
                        dataType: 'json',
